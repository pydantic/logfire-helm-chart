...
![Version: 0.8.9](https://img.shields.io/badge/Version-0.8.9-informational?style=flat-square) ![AppVersion: 7c65e7d1](https://img.shields.io/badge/AppVersion-7c65e7d1-informational?style=flat-square)
...
| otel_collector | object | `{"extraExporters":{},"extraExtensions":{},"extraLogsExporters":[],"extraLogsProcessors":[],"extraLogsReceivers":[],"extraMetricsExporters":[],"extraMetricsProcessors":[],"extraMetricsReceivers":[],"extraPipelines":{},"extraProcessors":{},"extraReceivers":{},"extraServiceExtensions":[],"extraTraceExporters":[],"extraTraceProcessors":[],"extraTraceReceivers":[],"prometheus":{"add_metric_suffixes":false,"enable_open_metrics":true,"enabled":false,"endpoint":"0.0.0.0","metric_expiration":"180m","port":9090,"resource_to_telemetry_conversion":{"enabled":true},"send_timestamp":true}}` | otel-collector configuration |
