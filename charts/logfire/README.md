...
The chart also supports optional workload sizing presets through `sizingPreset`. Leaving it empty keeps sizing driven entirely by explicit per-service values. The built-in `standard` preset applies the customer-oriented defaults in `values.yaml`, and you can still override any individual workload after selecting it.
...
| sizingPresets | object | `{"standard":{"logfire-backend":{"autoscaling":{"hpa":{"cpuAverage":25,"enabled":true,"memAverage":65},"maxReplicas":4,"minReplicas":2},"pdb":{"maxUnavailable":1},"resources":{"cpu":"750m","memory":"1Gi"}},"logfire-dex":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":65},"maxReplicas":3,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"100m","memory":"128Mi"}},"logfire-ff-cache-byte":{"autoscaling":{"hpa":{"cpuAverage":25,"enabled":true,"memAverage":65},"maxReplicas":6,"minReplicas":1},"resources":{"cpu":"1","memory":"5Gi"},"scratchVolume":{"storage":"32Gi"}},"logfire-ff-cache-ipc":{"autoscaling":{"hpa":{"cpuAverage":40,"enabled":true,"memAverage":65},"maxReplicas":6,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"2","memory":"8Gi"}},"logfire-ff-compaction-worker":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":50},"maxReplicas":16,"minReplicas":1},"datafusionMemory":"3072MB","pdb":{"maxUnavailable":1},"resources":{"cpu":"2","memory":"8Gi"},"scratchVolume":{"storage":"1Gi"}},"logfire-ff-crud-api":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":65},"maxReplicas":6,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"125m","memory":"512Mi"}},"logfire-ff-ingest":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":40},"maxReplicas":24,"minReplicas":2},"pdb":{"maxUnavailable":1},"resources":{"cpu":"1","memory":"2Gi"},"volumeClaimTemplates":{"storage":"16Gi"}},"logfire-ff-ingest-processor":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true},"maxReplicas":24,"minReplicas":2},"pdb":{"maxUnavailable":1},"resources":{"cpu":"2","memory":"4Gi"}},"logfire-ff-maintenance-scheduler":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true},"maxReplicas":3,"minReplicas":1},"datafusionMemory":"512MB","pdb":{"maxUnavailable":1},"resources":{"cpu":"500m","memory":"512Mi"}},"logfire-ff-maintenance-worker":{"autoscaling":{"hpa":{"cpuAverage":50,"enabled":true,"memAverage":50},"maxReplicas":16,"minReplicas":1},"datafusionMemory":"3072MB","pdb":{"maxUnavailable":1},"resources":{"cpu":"2","memory":"8Gi"},"scratchVolume":{"storage":"1Gi"}},"logfire-ff-proxy-cache-byte":{"autoscaling":{"hpa":{"cpuAverage":40,"enabled":true,"memAverage":65},"maxReplicas":6,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"750m","memory":"768Mi"}},"logfire-ff-proxy-cache-ipc":{"autoscaling":{"hpa":{"cpuAverage":40,"enabled":true,"memAverage":65},"maxReplicas":6,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"250m","memory":"256Mi"}},"logfire-ff-query-api":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":70},"maxReplicas":8,"minReplicas":2},"pdb":{"maxUnavailable":1},"resources":{"cpu":"2","memory":"8Gi"}},"logfire-frontend-service":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":70},"maxReplicas":3,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"100m","memory":"128Mi"}},"logfire-otel-collector":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true,"memAverage":70},"maxReplicas":2,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"1","memory":"1Gi"}},"logfire-remote-mcp":{"autoscaling":{"hpa":{"cpuAverage":60,"enabled":true},"maxReplicas":3,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"250m","memory":"640Mi"}},"logfire-service":{"autoscaling":{"hpa":{"cpuAverage":20,"enabled":true,"memAverage":65},"maxReplicas":6,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"1","memory":"1Gi"}},"logfire-worker":{"autoscaling":{"hpa":{"cpuAverage":70,"enabled":true,"memAverage":65},"maxReplicas":5,"minReplicas":1},"pdb":{"maxUnavailable":1},"resources":{"cpu":"250m","memory":"512Mi"}}}}` | Workload sizing presets. Explicit per-service values always override the selected preset. |
